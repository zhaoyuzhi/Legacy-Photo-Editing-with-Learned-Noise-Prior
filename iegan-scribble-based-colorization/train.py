...
if __name__ == "__main__":
    ...
    parser.add_argument('--classification_loss_net_path', type = str, default = "./trained_models/resnet50_bn_rgb_epoch150_bs256.pth", help = 'the load name of models')
    parser.add_argument('--perceptual_loss_net_path', type = str, default = "./trained_models/vgg16_pretrained.pth", help = 'the load name of models')
    # Training parameters
