...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type = str, \
        #default = 'E:\\code\\Legacy Photo Editing\\data\\ILSVRC2012_val_256_IEGAN_colorized(final_step)', \
        default = 'C:\\Users\\yzzha\\Desktop\\dataset\\temp2', \
    ...
    parser.add_argument('--baseroot', type = str, \
        ...
        default = "C:\\Users\\yzzha\\Desktop\\dataset\\temp", \
            help = 'the base training folder')
    parser.add_argument('--colorscribbleroot', type = str, \
        default = "E:\\code\\Legacy Photo Editing\\data\\input\\ILSVRC2012_val_256_colorscribble_30points", \
            help = 'the base training folder')
    ...
    # Define the dataset
    testset = dataset.ScribbleColorizationValDataset_Known_ColorScribble(opt)
    ...
    for batch_idx, (grayscale, img, color_scribble, imgname) in enumerate(dataloader):
        ...
        # save
        save_name = os.path.join(opt.save_path, imgname[0])
