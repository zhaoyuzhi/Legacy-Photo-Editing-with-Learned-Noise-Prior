...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_path', type = str, \
        default = "F:\\submitted papers\\my papers\\Legacy Photo Editing with Learned Noise Prior\\v1\\comparison results\\sample for comparison\\denoising\\proposed", \
    ...
    parser.add_argument('--baseroot', type = str, \
        ...
        #default = "F:\\submitted papers\\my papers\\Legacy Photo Editing with Learned Noise Prior\\v1\\comparison results\\sample for comparison\\teaser\\legacy_sample_masked_input\\611.jpg", \
        default = "F:\\submitted papers\\my papers\\Legacy Photo Editing with Learned Noise Prior\\v1\\comparison results\\sample for comparison\\denoising\\input\\1206.jpg", \
            help = 'the base training folder for inpainting network')
    parser.add_argument('--resize', type = int, default = 1024, help = 'size of image')
